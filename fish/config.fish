...
set --path -x PATH "$HOME/bin:$HOME/.cargo/bin:$HOME/.mix/escripts:$HOME/.rvm/bin:$_gitcontrib:$_gitcontrib/contacts:$_gitcontrib/diff-highlight:$_gitcontrib/git-jump:$_gitcontrib/stats:$_gitcontrib/subtree:$_gitcontrib/workdir:/Library/Apple/usr/bin:/System/Library/Tcl/bin:/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin:$PATH"
